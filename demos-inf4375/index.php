  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="starter-template">
        <h1>Laboratoires INF4375 - Automne 2014</h1>
        <ul class="list-group">
        <?php foreach(require('menu-items.php') as $key => $sem): ?>
          <li class="list-group-item"><a href="semaine<?php print $key; ?>.php">Semaine du <?php print $sem; ?></a></li>
        <?php endforeach; ?>
        </ul>
    </div><!-- /.container -->
